...
import { TouchableOpacity, ActivityIndicator, ImageBackground } from 'react-native';
...
import  ListComponent from '../../../../modules/common/component/impl/list.component';
import LocationComponent  from '../../../../modules/location/components/location.component';

/* Third Party Modules */
import { View, Button, Text, Container, Content, Grid, Row, CardItem, Body, Card } from 'native-base';
...
export default class HomeComponent extends React.Component<State, Props> implements CommonComponent {
    ...
    */
    ...
    public render() {
        return (
            ...
            <Row size={1}>
                <Card style={{flex :1}}>
                    <CardItem cardBody style={{flex : 1, padding : 0}}>
                        <ImageBackground source={{uri: 'https://www.telegraph.co.uk/content/dam/Travel/2018/January/sydney-best-GETTY.jpg'}}
                            resizeMode="cover" style={{flex :1, width: '100%', alignSelf :"stretch", alignItems : "center"}}
                        >
                            <LocationComponent locationOnInit={false} location={this.props.location.currentLocation}/>
                        </ImageBackground>
                    </CardItem>
                </Card>  
            </Row>
            <Row size={1}>
                <Card style={{flex :1}}>
                    <CardItem cardBody style={{flex : 1}}>
                        <ImageBackground source={{uri: "https://ak3.picdn.net/shutterstock/videos/3634493/thumb/3.jpg"}}
                            resizeMode="cover" style={{flex :1, width: '100%', alignSelf :"stretch", alignContent : "center"}}
                        >
                            <Button onPress={() => {Actions.splash()}} iconLeft dark style={{position : 'absolute', bottom : 0, alignSelf: "center"}}>
                                <Text>Alarms</Text>
                            </Button>
                        </ImageBackground>
                    </CardItem>
            ...
            <Row size={1}>
                <Card style={{flex :1}}>
                    <CardItem cardBody style={{flex : 1}}>
                        <ImageBackground source={{uri: "https://www.jdrgroup.co.uk/wp-content/uploads/2015/12/cogs.jpg"}}
                            resizeMode="cover" style={{flex :1, width: '100%', alignSelf :"stretch", alignContent : "center"}}
                        >
                            <Button onPress={() => {Actions.settings()}} iconLeft dark style={{position : 'absolute', bottom : 0, alignSelf: "center"}}>
                                <Text>Go to User Settings</Text>
                            </Button>
                        </ImageBackground>
                    </CardItem>
                </Card>
